"use strict";
/* mezanino-property-coordinates-v1 */
"use strict";

window.MezaninoContactConfig = Object.freeze({
  phoneDisplay: "(77) 98159-0101",
  phoneDigits: "5577981590101",
...
let properties = [
  {
    ...
    latitude: -12.805785,
    longitude: -38.307648,
    locationPrecision: "demo-neighborhood",
    price: "R$ 1.850.000",
    priceNumber: 1850000,
    bedrooms: 4,
    suites: 2,
  ...
  properties: {
    ...
    fields: [
      ...
      },
      {
        ...
        label: "CEP",
        type: "text",
        placeholder: "42700-000",
      },
      {
        name: "latitude",
        label: "Latitude da fachada",
        type: "number",
        placeholder: "-12.000000",
      },
      {
        name: "longitude",
        label: "Longitude da fachada",
        type: "number",
